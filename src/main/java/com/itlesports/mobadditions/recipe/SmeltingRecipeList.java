...
public class SmeltingRecipeList {
    ...
    public static void addSmeltingRecipes() {
        FurnaceRecipes.smelting().addSmelting(ModItems.rawCheval.itemID, new ItemStack(ModItems.cookedCheval), 0);
    ...
    public static void addCampfireRecipes() {
        RecipeManager.addCampfireRecipe(ModItems.rawCheval.itemID, new ItemStack(ModItems.cookedCheval));
